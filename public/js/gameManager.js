...
(function() {
  ...
  // ***** END SCOPE: launchProgram *****

  // ***** START SCOPE: getFileUrl *****
  /**
  ...
  // ***** END SCOPE: getFileUrl *****

  // ***** START SCOPE: loadProgramInContainer *****
  /**
  ...
  function loadProgramInContainer(fileUrl, program, container) {
    ...
    fetch(fileUrl, { method: 'HEAD' })
        .then(response => {
            ...
            // ***** END SCOPE: createIframe *****
            
            // ***** START SCOPE: iframeHandlers *****
            // Simple focus after iframe loads
            iframe.onload = () => {
  ...
  // ***** END SCOPE: loadProgramInContainer *****

  // ***** START SCOPE: createEmulatorPanel *****
  /**
  ...
  // ***** END SCOPE: createEmulatorPanel *****

  // ***** START SCOPE: makeDraggable *****
  /**
  ...
  // ***** END SCOPE: makeDraggable *****

  // ***** START SCOPE: loadProgramInEmulator *****
  /**
  ...
  // ***** END SCOPE: loadProgramInEmulator *****

  // ***** START SCOPE: closeEmulator *****
  /**
   * Close the emulator
   */
  ...
  // ***** END SCOPE: closeEmulator *****

  // ***** START SCOPE: toggleFullscreen *****
  /**
  ...
  // ***** END SCOPE: toggleFullscreen *****

  // ***** START SCOPE: launchByName *****
  /**
  ...
  // ***** END SCOPE: launchByName *****

  // ***** START SCOPE: isRunning *****
  /**
